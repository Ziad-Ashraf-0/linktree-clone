<template>
    <div id="AddLink" class="w-full bg-white rounded-3xl overflow-hidden">
        ...
        <form @submit.prevent="submit()" class="flex items-center gap-4 w-full pt-2 p-6">
            ...
            <div class="w-full">
                <TextInput class="w-full" placeholder="Name" v-model:input="name" inputType="text"
            ...
            <button type="submit" :disabled="!name && !url" @click="addLink()" class="rounded-full p-3 px-6" :class="name && url
